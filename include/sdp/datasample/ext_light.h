...
#ifndef SDP_DATASAMPLE_EXT_LIGHT_H__
#define SDP_DATASAMPLE_EXT_LIGHT_H__

#include <sdp/sdp.h>

/**
 * @file
 * @brief SDP_DS_TYPE_LIGHT extended type definitions
 * @ingroup DATASAMPLE
 * @{
 */
...
/** 
 * @brief Extended data type values for SDP_DS_TYPE_LIGHT (8-bit).
 * 
 * <b>Radiometric Units (SDP_DS_EXT_TYPE_LIGHT_RADIO_*)</b>
 * 
 ...
 * 
 * <b>Photometric Units (SDP_DS_EXT_TYPE_LIGHT_PHOTO_*)</b>
 * 
 ...
 */
enum sdp_ds_ext_light {
	SDP_DS_EXT_TYPE_LIGHT_UNDEFINED                 = 0, /**< lux */

	/* Radiometric units */
	SDP_DS_EXT_TYPE_LIGHT_RADIO_RADIANT_FLUX        = 0x10, /**< W */
	SDP_DS_EXT_TYPE_LIGHT_RADIO_RADIANT_INTEN       = 0x11, /**< W/sr */
	SDP_DS_EXT_TYPE_LIGHT_RADIO_IRRADIANCE          = 0x12, /**< W/m^2 */
	SDP_DS_EXT_TYPE_LIGHT_RADIO_RADIANCE            = 0x13, /**< W/(sr m^2) */

	/* Photometric units */
	SDP_DS_EXT_TYPE_LIGHT_PHOTO_LUM_FLUX            = 0x20, /**< lm */
	SDP_DS_EXT_TYPE_LIGHT_PHOTO_LUM_INTEN           = 0x21, /**< lm/sr or cd */
	SDP_DS_EXT_TYPE_LIGHT_PHOTO_ILLUMINANCE         = 0x22, /**< lm/m^2 or lux */
	SDP_DS_EXT_TYPE_LIGHT_PHOTO_LUMINANCE           = 0x23, /**< cd/m^2 */
};
...
#endif /* SDP_DATASAMPLE_EXT_LIGHT_H__ */
